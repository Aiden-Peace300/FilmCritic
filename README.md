...
- [IMDb API](https://tv-api.com/api): For fetching comprehensive information about movies and shows.
...
_The system employs a combination of AI and data from the IMDb API to provide a unique film discovery experience, resulting in a highly personalized movie selection for the user._
...
const addToFilmsTableAndWatchlist = useCallback(
  async (detailsObj) => {
    try {
      ...
      console.log('responseFilms after adding to films table: ', responseFilms);
...
_Behind the scenes, the application manages user-specific watchlists and stores relevant film information, allowing for easy access and exploration of saved films. Users can seamlessly access trailers and discover where to stream the film._
...
_Users can actively engage and interact with the film community. The system records and displays these user-generated reviews and ratings, enhancing the film discovery experience._
